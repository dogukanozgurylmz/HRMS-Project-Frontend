          ...
          <Container>
            <Form style={{marginTop:"6em"}} >
              <Form.Group widths='equal'>
                <Form.Input width={10} placeholder='İş ara...' />
                <Form.Select width={5} placeholder='City' />
                <Form.Button width={1} color="blue" icon="search"></Form.Button>
              </Form.Group>
            </Form>
        ...
        <Grid container stackable verticalAlign='middle'>
          ...
          <Grid.Row>
            <Grid.Column textAlign='center'>
              <Button basic size='huge'>See job postings</Button>
            </Grid.Column>
          </Grid.Row>
        </Grid>
      </Segment>
